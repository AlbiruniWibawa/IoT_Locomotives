...
public class SchedulerService {
    ...
    public void sendDataToNode() {
        String[] locomotiveNameList = { "Lokomotif 1", "Lokomotif 2", "Lokomotif 3", "Lokomotif 4", "Lokomotif 5", "Lokomotif 6", "Lokomotif 7", "Lokomotif 8", "Lokomotif 9", "Lokomotif 10" };
        ...
        logger.info("Sending dummy data to node JS: {}", data);
