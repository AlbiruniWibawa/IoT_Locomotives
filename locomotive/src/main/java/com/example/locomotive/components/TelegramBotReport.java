...
public class TelegramBotReport extends TelegramLongPollingBot {
    ...
    private static final String BOT_TOKEN = "6688476756:AAGiA0Uf_V0Tzet853S7Ea4qb4vPvDEzDh0";
    private static final String CHAT_ID = "7346480360";
